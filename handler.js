...
module.exports = {
    async handler(chatUpdate) {
        ...
        global.colong2 = '𝒟𝓎𝒶𝓃'
        global.kontak2 = [
        ['6285766454089', '𝒟𝓎𝒶𝓃', '𝙿𝚎𝚗𝚐𝚎𝚖𝚋𝚊𝚗𝚐', 'Gak donasi Gak papa asal tapi ntar aku nangis😭', true],
        ['6285866454089', await this.getName('6285766454089@s.whatsapp.net'), '𝑷𝒂𝒓𝒕𝒏𝒆𝒓 𝒟𝓎𝒶𝓃', true], 
        ]
